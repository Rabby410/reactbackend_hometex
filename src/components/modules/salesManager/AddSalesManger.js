                ...
                <div className="col-md-6">
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <div className="col-md-12">
                        <label className="w-100 mt-4">
                          ...
                          <input
                            ...
                            onChange={handleInput}
                            placeholder={
                              "Enter Sales Manager photo identification"
                            }
                          />
                          <p className={"login-error-msg"}>
                            <small>
                              {errors.nid != undefined ? errors.nid[0] : null}
                            </small>
                          </p>
                        </label>
                      </div>
                      ...
                      <div className="col-md-12">
                        <label className="w-100 mt-4">
                          <p>Select Sales Manager Type</p>
                          <select
                            className={
                              errors.employee_type !== undefined
                                ? "form-select mt-2 is-invalid"
                                : "form-select mt-2"
                            }
                            name="employee_type"
                            value={input.employee_type}
                            onChange={handleInput}
                          >
                        ...
                        <p className={"login-error-msg"}>
                          <small>
                            {errors.employee_type !== undefined
                              ? "Please select a Sales Manager Type"
                              : null}
                          </small>
                        </p>
                      </div>
