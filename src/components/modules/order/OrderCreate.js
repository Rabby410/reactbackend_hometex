                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="order-summary mt-1">
                        <p className="pb-2 m"><strong>Customer: </strong><span className="text-theme"> {orderSummary.customer}</span></p>
                      ...
                      {Object.keys(carts).map((key) => (
                        <div className="d-flex align-items-center my-2 p-1 order-product-container position-relative" key={key}>
                          <div className="details-area">
                    ...
                    <div className="card-body">
                      <div className="input-group">
                        <input
                          ...
                          placeholder={'search...'}
                        />
                        <button onClick={getCustomer} className="input-group-text bg-theme text-white">
                          <i className="fa-solid fa-search" />
                        </button>
                      </div>
                      ...
                      <ul className="customer-list">
                        {customers.map((customer, index) => (
                          <li
                            className={orderSummary.customer_id == customer.id ? 'text-theme' : ''}
                            onClick={() => selectCustomer(customer)} key={index}>{customer.name} - {customer.phone}
                          </li>
                        ))}
                      </ul>
