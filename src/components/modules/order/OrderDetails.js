...
const OrderDetails = () => {
    ...
    const getOrderDetails = () => {
        ...
        axios
            .get(
                `${Constants.BASE_URL}/order/${params.id}`,
                {
                    headers: {
                        ...
                        <div className="search-area mb-4 mx-3">
                                        ...
                                        <table className={"table table-hover table-bordered table-striped sm-table"}>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td className={"align-middle"}><img src={order?.shop?.logo} alt={'shop Logo'} className="table-image img-thumbnail" /></td>
                                                </tr>
                                                <tr>
                                                    <th className={"align-middle"}>Shop Name</th>
                                                    <td className={"align-middle"}>{order?.shop?.name}</td>
                                                </tr>
                                                <tr>
                            ...
                            <div className="col-md-12 mt-4">
                                <div className="card h-100">
                                    ...
                                    <div className="card-body">
                                        <table className={"table table-bordered table-hover table-striped sm-table"}>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td className="align-middle"><strong>{order?.quantity}</strong></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td className="align-middle"><strong>{order?.payment_status}</strong></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="align-middle"><strong className="text-theme">{GlobalFunction.formatPrice(order?.total)}</strong></td>
                                                </tr>
                                                <tr>
                                                    <th className="align-middle">Paid Amount</th>
                                                    <td className="align-middle"><strong className="text-success">{GlobalFunction.formatPrice(order?.paid_amount)}</strong></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="align-middle"><strong>{order?.updated_at}</strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div className="col-md-12 mt-4">
                                <div className="card h-100">
                                    ...
                                    <div className="card-body">
                                        <table className={"table table-bordered table-hover table-striped table-sm sm-table"}>
                                            <thead>
                                                <tr>
                                                    <th>SL</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                {order?.order_details.map((product, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className={"align-middle"}><img src={product?.photo} alt={'product photo'} className="table-image img-thumbnail" /></td>
                                                        <td className={"align-middle"}>
                                            ...
                                            <tbody>
                                                {order?.transactions.map((transaction, index) => (
                                                    <tr key={index}>
                                                        <td className={"align-middle"}> {++index}</td>
                                                        <td className={"align-middle"}>
                                                            <p>{transaction.trx_id}</p></td>
                                                        <td className={"align-middle"}>
                                                            <p>{GlobalFunction.formatPrice(transaction?.amount)}</p>
                                                        </td>
                                                        <td className={"align-middle"}>
                                                        ...
                                                        <td className={"align-middle"}>
                                                            <p>Payment Method: {transaction?.payment_method_name}</p>
