            ...
            <div className="card">
                ...
                <div className="table-responsive soft-landing">
                        <table className={"my-table table-sm product-table table table-hover table-striped table-bordered"}>
                            ...
                            <tbody>
                                {Object.keys(products).length > 0 ? products.map((product, number) => (
                                    <tr key={number}>
                                        ...
                                        <td>
                                            ...
                                            <p className={"text-success"}>Discount Start : {product.discount_start}</p>
                                        ...
                                        <td>
                                            <p className={"text-theme"}>Created: {product.created_at}</p>
                                            <p className={"text-success"}>Updated: {product.updated_at}</p>
