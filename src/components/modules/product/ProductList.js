            ...
            <div className="card">
                ...
                <div className="table-responsive soft-landing">
                        <table className={"my-table table table-hover table-striped table-bordered"}>
                            ...
                            <tbody>
                                {Object.keys(product).length > 0 ? product.map((product, number) => (
                                    <tr key={number}>
                                        ...
                                        <td>
                                            <p className={"text-theme"}>{product.serial}</p>
                                        ...
                                        <td>
                                            <p className={"text-theme"}>{product.created_at}</p>
                                            <p className={"text-success"}>
                                                {product.updated_at}
                                            </p>
                                        </td>
                                        <td>
                                            ...
                                            <Link to={`/product/edit/${product.id}`}><button className={"btn btn-sm my-1 mx-1 btn-warning"}><i class="fa-solid fa-pen-to-square"></i></button></Link>
                                            <button onClick={() => handleProductDelete(product.id)} className={"btn btn-sm my-1 btn-danger"}><i class="fa-solid fa-trash"></i></button>
                                        </td>
                                    </tr>
                                )): <NoDataFound/>}
                            </tbody>
