                ...
                <div className='row'>
                    {Object.keys(photos).map((key)=>(
                        <div className={'col-md-2 my-2'} key={key}>
                            <img onClick={()=>handlePrimaryPhoto(key)} src={photos[key].photo} className={ photos[key].is_primary == 1 ? 'primary-photo img-thumbnail preview-photo'  :'img-thumbnail' } alt={'preview'} />
                        </div>
                    ))}
                    <div className='row align-item-center my-2'>
                    <div className='col-md-9'>
                    <div className='progress' style={{ dispaly: `${progress <1 ? 'none': 'block'}` }}>
